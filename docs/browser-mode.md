...
- `--chatgpt-url`: override the ChatGPT base URL (e.g., a specific workspace/folder link such as `https://chatgpt.com/g/.../project`). `--browser-url` stays as a hidden alias.
