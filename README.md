...
| `--browser-agent-mode <on\|off\|current>`                       | Control ChatGPT Agent mode in browser runs (`on` enables, `off` disables, `current` keeps current state).                                                                                                                                                                                                                                 |
